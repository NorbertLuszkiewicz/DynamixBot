...
twitchCommends();
 ...
 test = async ()=>{await changeVolumeOnTime("dynam1x1",30,50,5000); setTimeout(async()=> await changeVolumeOnTime("dynam1x1",30,50,5000),3000); setTimeout(async()=> await changeVolumeOnTime("dynam1x1",30,50,5000),7000)} 
 test()
